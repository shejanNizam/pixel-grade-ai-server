...
> Slab creation currently fails with **503 "not configured"** because no image
> generation vendor has been chosen. This is a pending client decision, not a
> bug — see `docs/OPEN-QUESTIONS.md`.
